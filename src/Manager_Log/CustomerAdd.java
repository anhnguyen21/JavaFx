...
public class CustomerAdd extends Stage {
	...
	public CustomerAdd() {
		...
		Text tTitle = new Text("Add new customer");
		...
		register.setOnMouseClicked(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent event) {
				...
				if (txfname.getText().isEmpty() || txPhone.getText().isEmpty() || txUsername.getText().isEmpty()
					...
					CustomerDto customer = new CustomerDto(txfname.getText(), txPhone.getText(), txAddress.getText(),
							txGetGender.getText(), Date.valueOf(txDate.getValue()), txUsername.getText(),
							txPassword.getText());
					cus.insertCustomer(customer);
